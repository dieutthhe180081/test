...
import com.sep490.g28.hvh.be.validation.validator.OrganizationRegistrationStatusValidator;
 ...
 *
 * <p>This annotation validates that the value is same as one of value in {@link EOrgRegistrationStatus}.</p>
 *
 ...
 */
@Documented
@Constraint(validatedBy = OrganizationRegistrationStatusValidator.class)
@Target({ElementType.FIELD, ElementType.PARAMETER})
@Retention(RetentionPolicy.RUNTIME)
public @interface OrganizationRegistrationStatus {
    String message() default "INVALID_ORGANIZATION_REGISTRATION_STATUS";
